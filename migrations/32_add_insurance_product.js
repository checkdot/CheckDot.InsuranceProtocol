...
module.exports = async function (deployer, network, accounts) {
    ...
    const _data = web3.eth.abi.encodeParameters(_id, ['string', 'string', 'string', 'uint256', 'uint256', 'uint256', 'uint256', 'uint256', 'uint256'], [
        _name,
        _riskType,
        _uri,
    ...
    // await protocol.updateProduct(1, _data);//
};